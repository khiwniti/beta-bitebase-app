        ...
        <div className="flex-1 min-h-0 mb-4">
          {loading ? (
            ...
            <div className="space-y-2">
              <div className="text-base lg:text-base font-bold text-gray-900 dark:text-gray-100 leading-tight break-words">{value}</div>
              {change && (
    ...
    <div className={`bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden ${className}`}>
      ...
      <div className="p-3 sm:p-4 lg:p-6 border-b border-gray-200 dark:border-gray-700">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="min-w-0 flex-1">
            <h3 className="text-base sm:text-base font-semibold text-gray-900 dark:text-gray-100 truncate">{title}</h3>
          </div>
