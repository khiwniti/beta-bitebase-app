    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="bg-gradient-to-br from-primary-50 to-neutral-50 py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h1 className="text-base font-bold text-neutral-900 font-display mb-6">
            Pricing Plans
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-base font-semibold text-neutral-900 mb-2">Real-time Analytics</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-base font-semibold text-neutral-900 mb-2">AI-Powered Insights</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-base font-semibold text-neutral-900 mb-2">Enterprise Security</h3>
