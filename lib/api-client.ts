...
class ApiClient {
  ...
  constructor() {
    // Use unified backend service configuration
    this.baseUrl = API_CONFIG.BACKEND_SERVICE_URL || API_CONFIG.BASE_URL;
    ...
    if (!this.baseUrl || this.baseUrl === "undefined") {
      ...
      console.warn(
        "⚠️ Backend service URL is undefined, using fallback:",
        this.baseUrl,
      );
    }

    if (DEBUG.LOG_API_CALLS) {
      console.log("🔗 API Client initialized with unified backend:", this.baseUrl);
    }
  }
  ...
  private async requestEnhanced<T>(
    endpoint: string,
    options: RequestInit = {}
  ): Promise<ApiResponse<T>> {
    // Check rate limit
    ...
    // Use retry logic for important endpoints
    ...
    if (criticalEndpoints.some(ce => endpoint.includes(ce))) {
  ...
  > {
    return this.requestEnhanced("/restaurants/nearby", {
      method: "POST",
      body: JSON.stringify(params),
    });
  }
  ...
  async runPredictiveAnalytics(params: {
    restaurantId: string;
    analysisType?: "full" | "clustering" | "regression" | "time_series" | "nlp";
    timeHorizon?: number;
  }): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.AI.PREDICTIVE_ANALYTICS, {
      method: "POST",
      body: JSON.stringify(params),
    });
  }

  async performMarketSegmentation(params: {
    restaurantData?: any[];
    algorithm?: "k_means" | "hierarchical" | "dbscan";
  }): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.AI.MARKET_SEGMENTATION, {
      method: "POST",
      body: JSON.stringify(params),
    });
  }
  ...
  async predictSales(params: {
    ...
    return this.requestEnhanced(ENDPOINTS.AI.SALES_PREDICTION, {
      method: "POST",
      body: JSON.stringify(params),
    });
  }

  async analyzeSeasonalTrends(params: {
    restaurantId: string;
    timeSeriesData?: any[];
    forecastHorizon?: number;
  }): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.AI.SEASONAL_ANALYSIS, {
      method: "POST",
      body: JSON.stringify(params),
    });
  }

  async analyzeReviewSentiment(params: {
    restaurantId: string;
    reviews?: string[];
    includeAspects?: boolean;
    includeEmotions?: boolean;
  }): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.AI.SENTIMENT_ANALYSIS, {
      method: "POST",
      body: JSON.stringify(params),
    });
  }

  async getModelPerformanceMetrics(): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.AI.MODEL_PERFORMANCE, {
      method: "GET",
    });
  }

  // Data Integration Methods
  async getThaiEconomicIndicators(): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.DATA.ECONOMIC_INDICATORS, {
      method: "GET",
    });
  }

  async getSocialMediaSentiment(restaurantId: string): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.DATA.SOCIAL_SENTIMENT(restaurantId), {
      method: "GET",
    });
  }

  async getFootTrafficData(locationId: string): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.DATA.FOOT_TRAFFIC(locationId), {
      method: "GET",
    });
  }

  async getETLPipelineStatus(): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.DATA.ETL_STATUS, {
      method: "GET",
    });
  }

  async getDataQualityMetrics(): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.DATA.QUALITY_METRICS, {
      method: "GET",
    });
  }

  async checkDataSourceHealth(): Promise<ApiResponse<Record<string, boolean>>> {
    return this.requestEnhanced(ENDPOINTS.DATA.HEALTH_CHECK, {
      method: "GET",
    });
  }

  async getDataSourceStatus(): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.DATA.SOURCES_STATUS, {
      method: "GET",
    });
  }

  // Enterprise Methods
  async getEnterpriseSecurityStatus(): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.ENTERPRISE.SECURITY_STATUS, {
      method: "GET",
    });
  }

  async getEnterprisePerformanceMetrics(): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.ENTERPRISE.PERFORMANCE_METRICS, {
      method: "GET",
    });
  }

  async getEnterpriseScalabilityStatus(): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.ENTERPRISE.SCALABILITY_STATUS, {
      method: "GET",
    });
  }

  // Beta Testing Methods
  async submitBetaFeedback(params: {
    user_id: string;
    ...
    return this.requestEnhanced(ENDPOINTS.BETA.FEEDBACK_SUBMIT, {
      method: "POST",
      body: JSON.stringify(params),
    });
  }

  async getBetaUsersAnalytics(): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.BETA.USERS_ANALYTICS, {
      method: "GET",
    });
  }

  async getBetaUserDetails(userId: string): Promise<ApiResponse<any>> {
    return this.requestEnhanced(ENDPOINTS.BETA.USER_DETAILS(userId), {
      method: "GET",
    });
  }
}
